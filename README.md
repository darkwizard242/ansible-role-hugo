...
hugo_version  | 0.70.0                                                                                                                              | Defined to dynamically fetch the desired version to install. Defaults to: **0.70.0**
